                ...
                RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (!(dataSnapshot.child("Users").child(phone).exists())) {
                            HashMap<String, Object> userfdataMap = new HashMap<>();
                            userfdataMap.put("phone", phone);
                            userfdataMap.put("password", password);
                            userfdataMap.put("name", name);

                            RootRef.child("Users").child(phone).updateChildren(userfdataMap)
